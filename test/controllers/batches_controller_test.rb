...
class BatchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create batch" do
    assert_difference('Batch.count') do
      post batches_url, params: { batch: { stage: @batch.stage, type: @batch.type, year: @batch.year } }
    end
  ...
  test "should update batch" do
    patch batch_url(@batch), params: { batch: { stage: @batch.stage, type: @batch.type, year: @batch.year } }
